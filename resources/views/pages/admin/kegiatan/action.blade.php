<form action="{{ route('kegiatan.destroy', $no) }}" method="Post" class="d-flex" id="{{ 'delete-form-' . $no }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DeleteLabel">Hapus Kegiatan?</h5>
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <p class="text-danger" style="font-size:0.9em;">
                        ...
                        kegiatan ini akan terhapus.
                    </p>
                    <p class="text-danger" style="font-size:0.9em;">
                        Apakah anda yakin menghapus <strong>kegiatan {{ $nama }}</strong> ?
                        <br>
